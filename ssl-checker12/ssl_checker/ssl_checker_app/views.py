...
def upload_photo(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            photo.user = request.user  # Przypisz aktualnego użytkownika
            photo.save()
            return redirect('lista_zdjec')  # Przekieruj po przesłaniu zdjęcia
    else:
        form = PhotoForm()
...
def lista_zdjec(request):
    ...
    return render(request, 'lista_zdjec.html', {'photos': photos})
